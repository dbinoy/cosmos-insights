...
def register_workflow_product_impact_callbacks(app):
    ...
    @callback(
        ...
        [
            Input("workflow-product-impact-chart-wrapper", "n_clicks"),
    ...
    def toggle_product_impact_chart_modal(wrapper_clicks, modal_is_open, chart_figure, is_open_state):
        triggered_id = ctx.triggered[0]['prop_id'].split('.')[0] if ctx.triggered else None
        if triggered_id == "workflow-product-impact-chart-wrapper" and wrapper_clicks and not is_open_state:
